...
--Q.2 Write a SQL query to retreive all transactions where the category and the quantity sold is more than 2 in the month of Nov-2022
SELECT *
FROM retail_sales
...
--Q.6 Write a SQL query to find the total number of transactionss(transaction_id) made by each gender in each category.
SELECT 
	category,
	gender,
